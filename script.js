...
const projectData = {
  ...
  "airbnb-clone": {
    ...
    description:
      "A full-stack web application replicating core Airbnb functionality with modern web technologies and responsive design.",
    image: "/placeholder.svg?height=400&width=600",
    features: [
    ...
    technologies: ["React", "Node.js", "Express.js", "MongoDB", "JWT Authentication", "Stripe API"],
    status: "Completed",
    impact: "Showcases full-stack development skills and modern web application architecture.",
    github: "https://github.com/yugavardhank",
    demo: "https://www.linkedin.com/in/yugavardhank",
  },
